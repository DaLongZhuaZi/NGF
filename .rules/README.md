...
> 📚 **官方文档与下载入口**：涉及官方 API / 组件 / 工具 / 下载工具包时，先查阅 [official-doc-links.md](official-doc-links.md)（HarmonyOS / OpenHarmony 官方文档总入口、系统 API 参考、测试/UI 自动化、构建/打包/发布、工具包下载指引的统一索引），再结合具体技能文件执行。
